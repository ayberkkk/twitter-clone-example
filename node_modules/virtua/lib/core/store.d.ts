...
export declare const ACTION_BEFORE_MANUAL_SCROLL = 5;
export declare const ACTION_SCROLL_END = 6;
export declare const ACTION_MANUAL_SCROLL = 7;
type Actions = [type: typeof ACTION_ITEM_RESIZE, entries: ItemResize[]] | [type: typeof ACTION_VIEWPORT_RESIZE, size: number] | [
